    ...
    return (
        <div className="relative min-h-screen pt-32 pb-24">
            ...
            <div className="relative z-10 container mx-auto px-6">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-bold font-headings mb-6 italic tracking-tighter drop-shadow-xl bg-clip-text text-transparent bg-gradient-to-r from-white via-primary to-white">
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400">
                            Selected Work
                        </span>
                    </h1>
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        A focused collection of digital products, experiments, and systems I've built.
                    </p>
                </motion.div>
